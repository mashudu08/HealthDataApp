...
namespace HealthDataApp.Controllers
{
    public class AlertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlertId,AlertType,Timestamp,AlertDescription")] Alert alert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlertId,AlertType,Timestamp,AlertDescription")] Alert alert)
        {
            if (id != alert.AlertId)
            {
                return NotFound();
